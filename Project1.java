...
public class Project1 {
    public static void main ( String[] args ) {
        ...
        System.out.print("How many " + typeOfMail + " are you mailing");
    ...
    public static void printReceipt( Mail mail ) {
        ...
        //using variable for print statment
        String dash = ".".repeat(54);
        String dots = ":";
        String space = " ".repeat(51);
        ...
        System.out.printf(": Date: %-14s                 :\n: ", now);
        System.out.printf("%-2s:\n:",space);
        System.out.printf(" PRODUCT & DESTINATION \t COST                :\n:");
        System.out.printf(" %2s           :\n:",line);
        System.out.printf("%-5d", mail.getUnits());
        System.out.printf(" %-6ss",mail.getType());
        System.out.printf(" to %-10s",mail.getDestination()); 
        System.out.printf(" Price $ %-10.2f", mail.getPostagePerUnit()*mail.getUnits());
        System.out.printf("\t     :\n:");
        //System.out.printf(" %d %ss to %s Price $ %-5.2f              :\n:",mail.getUnits(), mail.getType(), 
        //mail.getDestination(),mail.getPostagePerUnit()*mail.getUnits()) ;
        double tax = (mail.getPostagePerUnit() * mail.getUnits()) * 0.06;
        System.out.printf("\t\t\t      Taxes $ %-10.2f", tax);
        System.out.printf("      :\n:");
        System.out.printf("\t\t\t     TOTAL $ %-10.2f", 
        mail.getPostagePerUnit() * mail.getUnits() + tax);
        System.out.printf("\t    :\n:");
        System.out.printf("%-2s :\n:",space);
        System.out.printf("Thank you for using the Ankh-Morpork Post Office!   :\n");
        System.out.printf("%2s\n", dash);
